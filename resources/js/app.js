...
// SELECT ALL ELEMENTS
//API ye istek gönderip verileri alıp ve bunu kullanıcıya gösterme adımına geldik.
//querySelector() yöntemi belgee belirtilen bir CSS seçiciyle eşleşen ilk öğeyi döndürür.
...
//Burada GEO eklenti aracının API sini kullanarak kullanıcının ülke kodunu alacağız.
...
// Total Cases ve Recovered verileri gelmiş olduu.
...
//Total Cases ve Recovered verileri gelmiş olduu.
   ...
   new_recovered_element.innerHTML=last_entry.total_recovered - '+${parseInt(last_entry.total_recovered.replace(/,/g,""))}';
